...
_STRINGS = {
    ...
    "prompt_select":       {"en": "Select option  [0–49 | T=target | K=AI key | S=stealth]",
                            "sw": "Chagua chaguo  [0–48 | T=target | K= Key ya AI | S=Stealth]"},
    ...
    "subdomain_finder_title": {"en": "DEEP SUBDOMAIN FINDER",  "sw": "UTAFUTAJI SUBDOMAIN WA KINA"},
    "email_finder_title":    {"en": "EMAIL FINDER",           "sw": "UTAFUTAJI EMAILS"},
    ...
    "sm48": {"en": "Subdomain Deep",     "sw": "Subdomain Deep"},
    "sm49": {"en": "Email Finder",      "sw": "Tafuta Emails"},
